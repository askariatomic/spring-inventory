...
public class BBMResult {
    ...
    public Integer getBbmID() {
        return bbmID;
    }
    
    public void setBbmID(Integer bbmID) {
        this.bbmID = bbmID;
    }

    public String getBbmFaktur() {
        return bbmFaktur;
    }

    public void setBbmFaktur(String bbmFaktur) {
        this.bbmFaktur = bbmFaktur;
    }
